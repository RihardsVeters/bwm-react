...
import {
  ...
  function MapComponent(props){
        ...
        <InfoWindow position={coordinates} options={{maxWidth: 300}}>
            <div>
                Uuups, there is a problem to find location on the map, we are trying to resolve
                problem as fast as possible. Contact host for additional information if you are
                still interested in booking this place. We are sorry for inconviance.  
            </div>
        </InfoWindow>}
        </GoogleMap>
        ) 
...
function withGeocode(WrappedComponent){
    return class extends React.Component{
        ...
        getGeocodedLocation(){
            ...
            //const location = 'asdasdasdasd' - error
